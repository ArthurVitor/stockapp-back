...
namespace StockApp.API.Migrations
{
    ...
    [Migration("20240528202829_initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BatchExitNote", b =>
                {
                    ...
                    b.HasKey("BatchId", "ExitNoteId");

                    b.HasIndex("ExitNoteId");

                    b.ToTable("BatchExitNote");
                });
            ...
            modelBuilder.Entity("BatchExitNote", b =>
                {
                    b.HasOne("StockApp.Models.Models.Batch", null)
                        .WithMany()
                        .HasForeignKey("BatchId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("StockApp.Models.Models.ExitNote", null)
                        .WithMany()
